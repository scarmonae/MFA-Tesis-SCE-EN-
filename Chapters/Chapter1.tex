...
%======================================================================
%
%  This chapter develops—within a continuous discursive flow—the context
%  of multispectral remote sensing in Colombia, the existing
%  science-and-technology gap, the research problem, the hypothesis and
%  the objectives that steer the present thesis.
%
%======================================================================
...
\noindent Within the C3 (Combat Climate Change) project—an interdisciplinary collaboration between Universidad EAFIT (Colombia) and the KTH Royal Institute of Technology (Sweden)—the need arose to develop an intelligent payload for an unmanned aerial vehicle (UAV) aimed at environmental monitoring of biodiversity and ecosystem health in Colombia. While KTH led the structural and aerodynamic design of the UAV platform, the EAFIT team took responsibility for the procurement and construction of the payload, later named the HuMath\textregistered{} QBee.\\
...
designed and manufactured multispectral optical payload achieving sub-metric
...
low-cost, low-mass visible–near-infrared multispectral optical system be
...
characterise a lightweight multispectral optical system composed of VIS and NIR
channels for integration on general purpose non-pressurized aircrafts, so that it generates
...
%----------------------------------------------------------------------
\noindent The optical system will cover the spectral range from 400 to 900 nm, operate
...
focuses on optical system engineering and calibration; the development of
...
with ground tests and flights on Colombian Air Force non-pressurized aircraft, from
whose analysis the validity of the stated hypothesis is established.\\

%----------------------------------------------------------------------
% \section{Contributions}
%----------------------------------------------------------------------
\noindent The work delivers a locally fabricated VIS + NIR optical payload whose
...
%----------------------------------------------------------------------
\noindent Following this introduction, Chapter~\ref{Chapter2} develops the optical design workflow and establishes the component-selection criteria; Chapter~\ref{Chapter3} documents procurement, integration, and the associated operation and flight testing; Chapter~\ref{Chapter4} reports the geometric and spectral characterisation of the multispectral optical system; and Chapter~\ref{chap:conclusiones} consolidates the conclusions while outlining future work.\\
