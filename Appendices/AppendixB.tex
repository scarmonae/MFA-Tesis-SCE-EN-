% Appendix B — Full system specifications

\chapter{Candidate Optical Systems: Full Specifications}
\label{ap:sistemas_candidatos}

This appendix compiles the complete specification tables for the eight
candidate optical systems considered in Chapter~\ref{Chapter2}. The tables
include detailed sensor parameters, objective characteristics, and derived
performance metrics such as AFOV, ground coverage, ground-sample distance and
MTF-based ground resolution at representative altitudes (50 m, 1000 m, 5000 m).\\

\noindent For traceability, this content corresponds to the comprehensive tables originally
drafted at the end of Chapter~\ref{Chapter2}. They were moved here to keep the
chapter focused and improve readability.

% If needed, the full tabular content can be pasted below or provided via an
% external input file (e.g., \input{Appendices/candidate_systems_tables.tex}).
% To avoid duplication and keep diffs manageable, the raw tables were commented
% out in Chapter~\ref{Chapter2} and are referenced here.
...
\cline{4-7}
  & & & \multicolumn{2}{c|}{\textbf{System 1}} & \multicolumn{2}{c|}{\textbf{System 2}} \\ \hline
\multicolumn{1}{|c|}{} &
...
\begin{tabular}{ccc|cc|cc|}
\cline{4-7}
  & & & \multicolumn{2}{c|}{\textbf{System 3}} & \multicolumn{2}{c|}{\textbf{System 4}} \\ \hline
\multicolumn{1}{|c|}{} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{EFEFEF}\textbf{Name}} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{EFEFEF}{\color[HTML]{0563C1} { Alvium 1800 U-2040 | 20.4 MP Sony IMX541 CMOS sensor - Allied Vision}}} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{EFEFEF}{\color[HTML]{0563C1} { Alvium 1800 U-2040 | 20.4 MP Sony IMX541 CMOS sensor - Allied Vision}}} \\
...
\begin{tabular}{ccc|cc|cc|}
\cline{4-7}
  & & & \multicolumn{2}{c|}{\textbf{System 5}} & \multicolumn{2}{c|}{\textbf{System 6 (NIR)}} \\ \hline
\multicolumn{1}{|c|}{} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{EFEFEF}\textbf{Name}} &
...
\begin{tabular}{ccc|cc|cc|}
\cline{4-7}
  & & & \multicolumn{2}{c|}{\textbf{System 7}} & \multicolumn{2}{c|}{\textbf{System 8}} \\ \hline
\multicolumn{1}{|c|}{} &
  \multicolumn{2}{c|}{\cellcolor[HTML]{EFEFEF}\textbf{Name}} &
